...
const SideBar = () => {
  ...
  return (
    <div
      className={`bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 h-full p-6 rounded-2xl overflow-y-scroll
      ...
      <div className='pb-6'>
        <div className='flex justify-between items-center'>
          ...
          <div className='relative py-2'>
            ...
            {menuOpen && (
              <div
                className='absolute top-full right-0 z-20 w-36 p-4 rounded-xl
        ...
        {/* Search Box */}
        <div
          className='bg-slate-800/70 rounded-2xl flex items-center gap-3
      py-4 px-5 mt-6 border border-slate-700/50 hover:border-slate-600/70 transition-all duration-200'
        >
          <img
